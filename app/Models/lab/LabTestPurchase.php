...
class LabTestPurchase extends Model
{
    use AutoTimeStamp, GlobalScope, SoftDeletes;
    protected $table = 'lab_test_purchases';
    ...
    {
        return $this->hasMany(LabTestPurchaseItem::class, 'purchase_id', 'id');
    }
    ...
    {
        return $this->hasMany(LabTestPurchasePaymentHistory::class, 'purchase_id', 'id');
    }
