...
namespace App\Http\Controllers\Backend\Pharmacy\Order;
...
class DeliveredController extends Controller
{
    ...
    public function index(Request $request)
    {
                ...
                ->addColumn('action', function ($row) {
                    $action = '<div class="dropdown">
                                <button class="btn btn-md dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" ><i class="fa fa-ellipsis-v" aria-hidden="true"></i></button>
                                    ...
                                    <a href="' . route('backend.pharmacy.order.order-list-delivered.show', $row) . '" class="dropdown-item"
        ...
        return view('backend.pharmacy.order.delivered', compact('status'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.pharmacy.order.show',
            compact(
                'order',
                'dis_status',
                'payment_methods',
