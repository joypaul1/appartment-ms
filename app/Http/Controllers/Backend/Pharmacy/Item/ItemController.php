...
namespace App\Http\Controllers\Backend\Pharmacy\Item;
...
class ItemController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu"><a href="' . route('backend.pharmacy.itemConfig.item.edit', $row) . '" class="dropdown-item">
                            <i class="fa fa-edit mr-2" aria-hidden="true"></i> Edit
                        </a><div class="dropdown-divider"></div>
                        <a data-href="' . route('backend.pharmacy.itemConfig.item.destroy', $row) . '" class="dropdown-item delete_check" data-toggle="tooltip" data-original-title="Delete" aria-describedby="tooltip64483">
        ...
        return View::make('backend.pharmacy.item.home.index');
    }
    ...
    public function create()
    {
        ...
        return View::make('backend.pharmacy.item.home.create')->with([
    ...
    public function edit(Item $item )
    {
        ...
        return View::make('backend.pharmacy.item.home.edit', compact('item'))
            ->with([
    ...
    public function itemInfo(Request $request)
    {
        ...
        return view('backend.pharmacy.item.home.itemInfo', compact('item',  'taxs'));
    }
    ...
    public function itemPosInfo(Request $request)
    {
        ...
        $taxs   = TaxSetting::active()->select('id', 'name', 'type', 'rate')->get();
        return view('backend.pharmacy.item.home.itemPosInfo', compact('item', 'units', 'taxs'));
    }
}
