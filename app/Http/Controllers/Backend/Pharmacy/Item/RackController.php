...
class RackController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="'.route('backend.pharmacy.itemConfig.rack.edit', $row).'"  type="button"
                    ...
                    $action .='<button  data-href="'.route('backend.pharmacy.itemConfig.rack.destroy', $row).'" type="button"
       ...
       return view('backend.pharmacy.item.rack.index');
    }
    ...
    {
        return view('backend.pharmacy.item.rack.create');
    }
    ...
    {
        return view('backend.pharmacy.item.rack.edit',compact('rack'));
    }
