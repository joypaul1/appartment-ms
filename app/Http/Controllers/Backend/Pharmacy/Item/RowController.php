...
class RowController extends Controller
{
        ...
        if (($request->rack_id !=null) && $request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="'.route('backend.pharmacy.itemConfig.row.edit', $row).'"  type="button"
                    ...
                    $action .='<button  data-href="'.route('backend.pharmacy.itemConfig.row.destroy', $row).'" type="button"
    ...
    {
        return view('backend.pharmacy.item.row.create')->with(['racks' => Rack::get(['id', 'name'])]);
    }
    ...
    {
        return view('backend.pharmacy.item.row.edit',compact('row'))->witH(['racks' => Rack::get(['id', 'name'])]);
    }
