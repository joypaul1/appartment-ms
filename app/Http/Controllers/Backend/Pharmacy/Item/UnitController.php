...
class UnitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="'.route('backend.pharmacy.itemConfig.unit.edit', $row).'"  type="button"
                    ...
                    $action .='<button  data-href="'.route('backend.pharmacy.itemConfig.unit.destroy', $row).'" type="button"
       ...
       return view('backend.pharmacy.item.unit.index');
    }
    ...
    {
        return view('backend.pharmacy.item.unit.create');
    }
    ...
    {
        return view('backend.pharmacy.item.unit.edit',compact('unit'));
    }
