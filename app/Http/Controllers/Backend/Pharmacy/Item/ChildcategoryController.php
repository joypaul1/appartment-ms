...
class ChildCategoryController extends Controller
{
    ...
    {
        $childcategories = ChildCategory::where('category_id',1)->select('id', 'name', 'slug', 'image', 'status', 'category_id', 'subcategory_id');
        ...
        return view('backend.pharmacy.item.childcategory.index', compact('childcategories'));
    }
    ...
    {
        return view('backend.pharmacy.item.childcategory.create', ['subcategories' => Subcategory::where('category_id',1)->get(['id', 'name'])]);
    }
    ...
    {
        return view('backend.pharmacy.item.childcategory.edit',['categories' => Category::get(['id', 'name']),
