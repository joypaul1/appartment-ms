        ...
        if ($request->ajax()) {
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<a  href="' . route('backend.pharmacy.itemConfig.type.edit', $row) . '" class="btn btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit"><i class="icon-pencil" aria-hidden="true"></i></a>';
                    $action .= '<button  data-href="' . route('backend.pharmacy.itemConfig.type.destroy', $row) . '" type="button"
