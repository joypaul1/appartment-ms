...
class UnitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="'.route('backend.pathology.itemConfig.unit.edit', $row).'"  type="button"
                    ...
                    $action .='<button  data-href="'.route('backend.pathology.itemConfig.unit.destroy', $row).'" type="button"
       ...
       return view('backend.pathology.item.unit.index');
    }
    ...
    {
        return view('backend.pathology.item.unit.create');
    }
    ...
    {
        return view('backend.pathology.item.unit.edit',compact('unit'));
    }
