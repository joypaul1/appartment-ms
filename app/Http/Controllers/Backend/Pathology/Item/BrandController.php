...
class BrandController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<a  href="'.route('backend.pathology.itemConfig.brand.edit', $row).'" class="btn btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit"><i class="icon-pencil" aria-hidden="true"></i></a>';
                    $action .='<button  data-href="'.route('backend.pathology.itemConfig.brand.destroy', $row).'" type="button"
       ...
       return view('backend.pathology.item.brand.index');
    }
    ...
    {
        return view('backend.pathology.item.brand.create');
    }
    ...
    public function edit(Brand $brand )
    {
        ...
        return view('backend.pathology.item.brand.edit',compact('brand'));
    }
