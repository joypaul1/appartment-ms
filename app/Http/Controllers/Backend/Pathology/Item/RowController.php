...
class RowController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (($request->rack_id !=null) && $request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="'.route('backend.pathology.itemConfig.row.edit', $row).'"  type="button"
                    ...
                    $action .='<button  data-href="'.route('backend.pathology.itemConfig.row.destroy', $row).'" type="button"
       ...
       return view('backend.pathology.item.row.index');
    }
    ...
    {
        return view('backend.pathology.item.row.create')->with(['racks' => Rack::get(['id', 'name'])]);
    }
    ...
    {
        return view('backend.pathology.item.row.edit',compact('row'))->witH(['racks' => Rack::get(['id', 'name'])]);
    }
