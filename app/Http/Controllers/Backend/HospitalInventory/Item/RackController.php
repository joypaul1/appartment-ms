...
class RackController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="'.route('backend.hospital_inventory.itemConfig.rack.edit', $row).'"  type="button"
                    ...
                    $action .='<button  data-href="'.route('backend.hospital_inventory.itemConfig.rack.destroy', $row).'" type="button"
       ...
       return view('backend.hospital_inventory.item.rack.index');
    }
    ...
    {
        return view('backend.hospital_inventory.item.rack.create');
    }
    ...
    {
        return view('backend.hospital_inventory.item.rack.edit',compact('rack'));
    }
