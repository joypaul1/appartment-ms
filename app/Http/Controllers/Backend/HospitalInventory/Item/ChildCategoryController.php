...
class ChildCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.hospital_inventory.item.childcategory.index', compact('childcategories'));
    }
    ...
    {
        return view('backend.hospital_inventory.item.childcategory.create',  ['subcategories' => Subcategory::where('category_id',3)->get(['id', 'name'])]);
    }
    ...
    {
        return view('backend.hospital_inventory.item.childcategory.edit',['categories' => Category::get(['id', 'name']),
