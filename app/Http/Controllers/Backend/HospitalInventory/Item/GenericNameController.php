...
class GenericNameController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="' . route('backend.hospital_inventory.itemConfig.generic-name.edit', $row) . '"  type="button"
                    ...
                    $action .= '<button  data-href="' . route('backend.hospital_inventory.itemConfig.generic-name.destroy', $row) . '" type="button"
        ...
        return view('backend.hospital_inventory.item.generic.index');
    }
    ...
    {
        return view('backend.hospital_inventory.item.generic.create');
    }
    ...
    {
        return view('backend.hospital_inventory.item.generic.edit', compact('genericName'));
    }
