...
class UnitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="'.route('backend.hospital_inventory.itemConfig.unit.edit', $row).'"  type="button"
                    ...
                    $action .='<button  data-href="'.route('backend.hospital_inventory.itemConfig.unit.destroy', $row).'" type="button"
       ...
       return view('backend.hospital_inventory.item.unit.index');
    }
    ...
    {
        return view('backend.hospital_inventory.item.unit.create');
    }
    ...
    {
        return view('backend.hospital_inventory.item.unit.edit',compact('unit'));
    }
