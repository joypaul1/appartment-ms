...
class RadiologyServiceInvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $labInvoices =  $labInvoices->with('patient:id,name,patientId','itemDetails')->whereHas('itemDetails.serviceName', function ($query) {
    ...
    {
        $radiologyServiceInvoice = LabInvoice::whereId($id)
        ->with('itemDetails.serviceName:id,name', 'patient')
        ->first();
    ...
    {
        $radiologyServiceInvoice = RadiologyServiceInvoice::whereId($id)
        ->with('itemDetails.serviceName:id,name')
        ->with('patient', 'paymentHistories.paymentMethodName')->first();
        return view('backend.radiology.historymoneyReceipt', compact('radiologyServiceInvoice'));
    }
