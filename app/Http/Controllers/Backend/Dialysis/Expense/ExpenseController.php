...
namespace App\Http\Controllers\Backend\Dialysis\Expense;
...
class ExpenseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $expense = Expense::query()->where('category', 'Dialysis');
        ...
        return view('backend.dialysis.expense.index', compact('payment_methods', 'payment_accounts', 'expense', 'expense_type'));
    }
    ...
    public function create()
    {
        ...
        $payment_methods    = PaymentSystem::get(['id', 'name']);
        $payment_accounts   = AccountLedger::where('rec_pay', true)->get(['id', 'name']);
        return view('backend.dialysis.expense.create', compact('payment_methods', 'payment_accounts', 'expense_type'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('backend.dialysis.expense.index')->with(['success' => 'Expense has been created successfully.']);
    }
