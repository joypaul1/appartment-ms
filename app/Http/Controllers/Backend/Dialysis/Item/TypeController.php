...
class TypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<a  href="' . route('backend.dialysis.itemConfig.type.edit', $row) . '" class="btn btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit"><i class="icon-pencil" aria-hidden="true"></i></a>';
                    $action .= '<button  data-href="' . route('backend.dialysis.itemConfig.type.destroy', $row) . '" type="button"
        ...
        return view('backend.dialysis.item.type.index');
    }
    ...
    {
        return view('backend.dialysis.item.type.create');
    }
    ...
    {
        return view('backend.dialysis.item.type.edit', compact('type'));
    }
