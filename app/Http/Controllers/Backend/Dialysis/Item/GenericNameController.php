...
class GenericNameController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="' . route('backend.dialysis.itemConfig.generic-name.edit', $row) . '"  type="button"
                    ...
                    $action .= '<button  data-href="' . route('backend.dialysis.itemConfig.generic-name.destroy', $row) . '" type="button"
        ...
        return view('backend.dialysis.item.generic.index');
    }
    ...
    {
        return view('backend.dialysis.item.generic.create');
    }
    ...
    {
        return view('backend.dialysis.item.generic.edit', compact('genericName'));
    }
