...
class ColorController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<a  href="'.route('backend.dialysis.itemConfig.color.edit', $row).'" class="btn btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit"><i class="icon-pencil" aria-hidden="true"></i></a>';
                    $action .='<button  data-href="'.route('backend.dialysis.itemConfig.color.destroy', $row).'" type="button"
       ...
       return view('backend.dialysis.item.color.index');
    }
    ...
    {
        return view('backend.dialysis.item.color.create');
    }
    ...
    {
        return view('backend.dialysis.item.color.edit',compact('color'));
    }
