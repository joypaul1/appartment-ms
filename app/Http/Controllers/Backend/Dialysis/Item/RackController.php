...
class RackController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $action = '<button  data-href="'.route('backend.dialysis.itemConfig.rack.edit', $row).'"  type="button"
                    ...
                    $action .='<button  data-href="'.route('backend.dialysis.itemConfig.rack.destroy', $row).'" type="button"
       ...
       return view('backend.dialysis.item.rack.index');
    }
    ...
    {
        return view('backend.dialysis.item.rack.create');
    }
    ...
    {
        return view('backend.dialysis.item.rack.edit',compact('rack'));
    }
