...
class ChildCategoryController extends Controller
{
    ...
    {
        $childcategories = ChildCategory::where('category_id',2)->select('id', 'name', 'slug', 'image', 'status', 'category_id', 'subcategory_id');
        ...
        return view('backend.dialysis.item.childcategory.index', compact('childcategories'));
    }
    ...
    {
        return view('backend.dialysis.item.childcategory.create',  ['subcategories' => Subcategory::where('category_id',2)->get(['id', 'name'])]);
    }
    ...
    {
        return view('backend.dialysis.item.childcategory.edit',['categories' => Category::get(['id', 'name']),
