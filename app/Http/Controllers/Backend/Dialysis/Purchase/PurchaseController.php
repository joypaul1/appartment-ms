...
namespace App\Http\Controllers\Backend\Dialysis\Purchase;
...
class PurchaseController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        $data = Purchase::where('purchase_type', 'dialysis')->
        latest();
        if($request->status == '1'){
            $data = $data->active();
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    <button class="btn btn-md dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" ><i class="fa fa-ellipsis-v" aria-hidden="true"></i></button>
                        ...
                        <a data-href="'.route('backend.dialysis.purchase.edit', $row).'" class="dropdown-item edit_check"
                            data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit mr-2" aria-hidden="true"></i> Edit
                        </a>
                        <div class="dropdown-divider"></div>
                        <a data-href="'.route('backend.dialysis.purchase.destroy', $row).'"class="dropdown-item delete_check"  data-toggle="tooltip"
        ...
        return view('backend.dialysis.purchase.index', compact('pur_status', 'dis_status'));
    ...
    public function create()
    {
        ...
        return view('backend.dialysis.purchase.create',compact('pur_status', 'dis_status','payment_accounts', 'payment_methods', 'taxs'));
    }
