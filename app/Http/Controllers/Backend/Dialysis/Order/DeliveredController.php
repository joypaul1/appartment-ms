<?php
namespace App\Http\Controllers\Backend\Dialysis\Order;
...
class DeliveredController extends Controller
{
    ...
    public function index(Request $request)
    {
                ...
                ->addColumn('action', function ($row) {
                    $action ='<div class="dropdown">
                                <button class="btn btn-md dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" ><i class="fa fa-ellipsis-v" aria-hidden="true"></i></button>
                                    ...
                                    <a href="'.route('backend.dialysis.order.order-list-delivered.show', $row).'" class="dropdown-item"
        ...
        return view('backend.dialysis.order.delivered', compact('status'));
    }
    ...
    public function show($id)
    {
       ...
       ->first();
        ...
        return view('backend.dialysis.order.show',
