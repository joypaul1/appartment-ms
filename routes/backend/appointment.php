...
Route::group(['middleware' => 'admin', 'prefix' =>'admin' , 'as'=>'backend.'], function(){
    ...
    Route::get('appointment/payment/{id}', [AppointmentController::class, 'payment'])->name('appointment.payment');
    Route::post('appointment/paymentStore/{id}', [AppointmentController::class, 'paymentStore'])->name('appointment.paymentStore');
});

// dailyses appointment
Route::group(['middleware' => 'admin', 'prefix' =>'admin' , 'as'=>'backend.'], function(){
    Route::resource('dialysis-appointment', DialysisAppointmentController::class);
    Route::get('dialysis-service-index', [DialysisAppointmentController::class, 'serviceInvoiceIndex'])->name('dialysis.service.index');
