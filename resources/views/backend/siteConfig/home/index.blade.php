...
<form class="needs-validation" action="{{ route('backend.site-config.system.store') }}" method="Post" enctype="multipart/form-data">
    @method('POST')
    @csrf
    <div class="card">
                ...
                <div class="form-validation">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control show-tick ms select2" id="country" name="country" data-placeholder="Select" required>
                            ...
                            <option value="{{ $country['name'] }}" {{ $siteInfo->country == $country['name'] ? 'Selected' : ' ' }}>
                                {{ $country['name'] }}</option>
                            @empty
                            @endforelse
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control show-tick ms select2" id="currency" name="currency" data-placeholder="Select" required>
                            ...
                            <option value="{{ $currency['name'] }}" {{ $siteInfo->currency == $currency['name'] ? 'Selected' : ' ' }}>
                    ...
                    <div class="form-group">
                        ...
                        'label' =>__('langdata.currency_symbol'),
                    ...
                    <div class="form-group">
                        <label for="currency_symbol_placement">{{ __('langdata.currency_symbol_placement') }}</label>
