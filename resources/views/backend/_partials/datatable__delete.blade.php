...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend') }}/vendor/jquery-datatable/buttons.dataTables.min.css">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/backend') }}/vendor/jquery-datatable/responsive.dataTables.min.css">
