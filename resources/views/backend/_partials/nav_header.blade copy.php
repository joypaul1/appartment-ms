        ...
        <div class="navbar-right">
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="{{ route('backend.pharmacy.pos.create') }}" data-toggle="tooltip" data-placement="bottom"
                            title="Pharmacy POS" class="icon-menu d-none d-sm-block d-md-none d-lg-block">
                            <i class="fa fa-cart-arrow-down" aria-hidden="true"></i>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('backend.dialysis.pos.create') }}" data-toggle="tooltip" data-placement="bottom"
                            title="Dialysis POS" class="icon-menu d-none d-sm-block d-md-none d-lg-block">
                            <i class="fa fa-cart-arrow-down" aria-hidden="true"></i>

                        </a>
                    </li>
                    {{-- <li>
                        <a href="{{ route('backend.pos.create') }}" target="_blank" class="icon-menu d-none d-sm-block"
                            data-toggle="tooltip" data-placement="bottom" title="POS">
                            <img src="{{ asset('assets/backend/pos.png') }}" alt=""
                                style="width:22px;transform: scale(1.8)">

                        </a>
                    </li>
                    <li>
                        <a href="{{ route('backend.siteConfig.filemanager') }}"
                            class="icon-menu d-none d-sm-block d-md-none d-lg-block"><i
                                class="fa fa-folder-open-o"></i></a>
                    </li>
                    <li>
                        <a href="{{ route('backend.personal-locker.index') }}"
                            class="icon-menu d-none d-sm-block d-md-none d-lg-block"><i class="icon-drawer"></i></a>
                    </li>
                    <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu user-menu menu-icon">
                            ...
                            <li>
                                <a href="javascript:void(0);"><i class="icon-equalizer"></i>
