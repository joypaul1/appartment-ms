...
@section('content')
@section('page-header')
<i class="fa fa-list"></i> @lang('title.Bill-Type-List')
@stop
@section('table_header')
@include('backend._partials.page_header', [
'fa' => 'fa fa-plus-circle',
'name' => 'Create Bill Type',
'name' => __('title.Create-Bill-Type') ,
...
<div class="row">
    <div class="col-12">
        <div class="card">
            @yield('table_header')
            <div class="card-body">
                <table id="datatable-reponsive" class="table  table-responsive text-center" style="width:100%">
                    <thead>
                        <tr>
                            <th>@lang('table.sl')</th>
