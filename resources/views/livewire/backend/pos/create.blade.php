        ...
        <div class="card d-flex  mt-5">
            <div class="header">
                <span href="#" style="font-size: 18px;font-weight:700">
                    <i class="fa fa-desktop"></i> Pharmacy Point OF Sell (POS)

                </span>

                <div class="pull-right">
                    <a href="{{ url('admin/pharmacy/pos') }}">
                        <button class="btn btn-warning text-white btn-md mr-1" onclick="deleteAll()">New Sale</button>
                    </a>
                    <a href="{{ route('backend.pharmacy.order.order-list-delivered.index') }}" target="_blank"><button
    ...
    <script>
        ...
        $("#product_name").autocomplete({
            source: function(request, response) {
                ...
                $.ajax({
                    method: 'GET',
                    url: "{{ route('backend.pharmacy.itemConfig.item.index') }}",
                    data: {
